...
previewImage: '../assets/posts/deniable-encryption.png'
openGraphImage: '../assets/posts/deniable-encryption.png'
tags:
  - privacy
  - encryption
---
...
import PreviewImage from '../assets/posts/deniable-encryption.png'

<Image
  src={PreviewImage}
  class="mx-auto my-0 w-4/5 sm:w-2/3"
  data-img-embed
  alt="A hard drive, locked with a padlock"
  loading="eager"
/>
