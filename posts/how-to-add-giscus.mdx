...
openGraphImage: '../assets/posts/how-to-add-giscus.png'
previewImage: '../assets/posts/how-to-add-giscus.png'
tags:
  - astro
---
...
import PreviewImage from '../assets/posts/how-to-add-giscus.png'
...
Embed the _Giscus_ client-side script bundle on your site, configure it with the correct repository URL, and users can view and write comments[^github-login].
...
[^github-login]: Requires users to be logged into a _GitHub_ account.
