...
- **Do your homework** - Don't take my, or anyone else's, words as absolute truth. Think about what _you_ want from the service and whether it can provide that. Inform yourself about the track record of the product and the company behind it. Explore and compare alternatives.
...
- **Use Open Source** - Prefer [OSS](https://en.wikipedia.org/wiki/Open-source_software) (**O**pen **S**ource **S**oftware) over proprietary software; with the source code open to the public, it generally ensures that no shady practices are being done behind the scenes.
...
<Image
  ...
  class="mx-auto my-0 w-4/5 sm:w-2/3"
  data-img-embed
  alt="A metal gate that is closed securely with a sturdy padlock"
  loading="eager"
/>
...
<Image
  ...
  class="mx-auto my-0 w-4/5 sm:w-2/3"
  data-img-embed
  alt="A green landscape of trees and grassy hills, with a rainbow in the distance"
  loading="eager"
/>
